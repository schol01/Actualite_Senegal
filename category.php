...
<html lang="en">
  ...
  <head>
    ...
    <title>Actualite Senegal | Catégorie</title>
...
?>
<h1> Infos <?php echo htmlentities($row['category']);?> </h1>
          <div class="card mb-4">
       <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
            <div class="card-body">
              <h2 class="card-title"><?php echo htmlentities($row['posttitle']);?></h2>
           
              <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="btn btn-primary">Lire plus &rarr;</a>
            </div>
            <div class="card-footer text-muted">
              Publié le <?php echo htmlentities($row['postingdate']);?>
...
<?php } ?>
    ...
    <ul class="pagination justify-content-center mb-4">
        <li class="page-item"><a href="?pageno=1"  class="page-link">Premiere</a></li>
        ...
        <li class="page-item"><a href="?pageno=<?php echo $total_pages; ?>" class="page-link">Derniere</a></li>
    </ul>
<?php } ?>
