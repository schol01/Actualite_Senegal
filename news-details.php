...
<html lang="fr">
  ...
  <head>
    ...
    <title>Actualite Senegal | Page d'accueil</title>
...
<p>
          ...
          <b>Publié par </b> <?php echo htmlentities($row['postedBy']);?> on </b><?php echo htmlentities($row['postingdate']);?> |
          <?php if($row['lastUpdatedBy']!=''):?>
          <b>Derniere mise à jour par </b> <?php echo htmlentities($row['lastUpdatedBy']);?> on </b><?php echo htmlentities($row['UpdationDate']);?></p>
        <?php endif;?>
...
<input type="text" name="name" class="form-control" placeholder="Saisissez votre nom" required>
 ...
 <div class="form-group">
 <input type="email" name="email" class="form-control" placeholder="Saisissez votre email valide" required>
 </div>
